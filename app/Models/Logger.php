...
class Logger extends Model
{
    ...
    protected $fillable = [
        ...
        'ministesy_last_forwarded_data_at',
        'logger_mode',
        'calibration_data',
        'calibrated_at',
        'last_sync_status',
    ...
    protected function casts(): array
    {
        return [
            ...
            'ministesy_last_forwarded_data_at' => 'datetime',
            'cpu_usage' => 'integer',
            ...
            'power_rails' => 'array',
            'power_read_at' => 'datetime',
            'leo_send_config' => 'array',
            'sdcard_total' => 'integer',
            'sdcard_used' => 'integer',
            'dhcp_mode' => 'boolean',
            'reboot_counter' => 'integer',
            'reboot_daily' => 'integer',
    ...
    {
        return $this->hasMany(LoggerIntegration::class);
    }
